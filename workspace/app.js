...
function formatText(value){
  ...
  for(const match of text.matchAll(pattern)){
    ...
    result+=esc(text.slice(cursor,match.index))+(a?mention(a.id):esc(match[0]));cursor=match.index+match[0].length;
  }
